...
public class ExchangeDataController {
    ...
    @Autowired @Qualifier("reportTopic") private NewTopic reportTopic;
    @Autowired @Qualifier("orderTopic") private NewTopic orderTopic;
    ...
    public void marketData(@RequestBody ReportingServiceDto newData) {
        ...
        if (!tradeNotificationService.tradeExist(newData.getOrderID())){
            ...
            notificationPublisher.setTopic(orderTopic);

            //publish orders on orders topic
//            KafkaPublish.setTopic(reportTopic);
...
//            KafkaPublish.sendMessage(newData);
        ...
        //publish trades on trade topic
            ...
            System.out.println("this is a trade");
            notificationPublisher.sendMessage(newData);
        }
        ...
        orderingServicePublisher.setTopic(orderTopic);
        System.out.println(orderTopic.name());
